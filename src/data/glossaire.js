...
export const glossaireData = [
  ...
  {
    terme: 'RDV pris',
    definition: "Rendez-vous commerciaux planifiés à la suite de la prospection téléphonique, comptés à leur date de prise : un rendez-vous pris le 28 juillet pour le 3 septembre compte dans les RDV pris de juillet.",
  ...
  },
  {
    ...
    definition: "Rendez-vous honorés rapportés aux rendez-vous dont le créneau tombe dans la période et est déjà passé, quelle que soit la date à laquelle ils ont été pris. Méthode convenue avec l'équipe le 15/09/2026 : le volume se lit à la prise (RDV pris), la réalisation au créneau (RDV honorés), comme pour les variables des télémarketeurs. Un créneau prévu plus tard dans la période n'est pas compté tant qu'il n'est pas passé, et un créneau du jour compte à partir du lendemain.",
    source: 'Fichier RDV (Google Sheet)',
    dashboards: ['commercial-activite'],
  },
  {
    terme: 'RDV à venir',
    definition: "Rendez-vous pris sur la période dont le créneau n'est pas encore arrivé. Ils comptent dans les « RDV pris » de la période où ils ont été pris, et entreront dans les honorés et le taux de la période où tombe leur créneau.",
    source: 'Fichier RDV (Google Sheet)',
    dashboards: ['commercial-activite'],
  },
  {
